...
func unitTests() {
	Describe("VMRequestedCapacityHandler", func() {
		Context("WriteResponse", testVMRequestedCapacityHandlerWriteResponse)
		Context("ServeHTTP", testVMRequestedCapacityHandlerServeHTTP)
		Context("Handle", testVMRequestedCapacityHandlerHandle)
		Context("HandleCreate", testVMRequestedCapacityHandlerHandleCreate)
		Context("HandleUpdate", testVMRequestedCapacityHandlerHandleUpdate)
	})
	Describe("VMSnapshotRequestedCapacityHandler", func() {
		Context("WriteResponse", testVMSnapshotRequestedCapacityHandlerWriteResponse)
		Context("ServeHTTP", testVMSnapshotRequestedCapacityHandlerServeHTTP)
		Context("Handle", testVMSnapshotRequestedCapacityHandlerHandle)
		Context("HandleCreate", testVMSnapshotRequestedCapacityHandlerHandleCreate)
	})
...
func testVMSnapshotRequestedCapacityHandlerHandleCreate() {
	...
	When("HandleCreate is called", func() {
		...
		Context("VM's storage class is present", func() {
			BeforeEach(func() {
				withObjects = append(withObjects, builder.DummyStorageClass())
			})
